...
exports.validateContentType = exports.sanitizeInput = exports.validateQueryParams = exports.validateAnalyticsRequest = exports.validateFeedbackRequest = exports.validateQueryRequest = exports.validateRequest = void 0;
...
const analyticsRequestSchema = zod_1.z.object({
    ...
    granularity: zod_1.z.enum(['hour', 'day', 'week', 'month', 'quarter', 'year']).optional()
});
...
exports.validateAnalyticsRequest = (0, exports.validateRequest)(analyticsRequestSchema);
