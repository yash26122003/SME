...
export type IndustryType = 'retail' | 'professional-services' | 'manufacturing' | 'healthcare' | 'education' | 'hospitality' | 'technology' | 'finance' | 'other';
...
export type MetricCategory = 'revenue' | 'expenses' | 'customers' | 'inventory' | 'employees' | 'operations' | 'marketing' | 'sales';
...
export type InsightType = 'trend' | 'anomaly' | 'forecast' | 'opportunity' | 'risk' | 'benchmark';
...
export type WidgetType = 'metric' | 'chart' | 'table' | 'insight' | 'kpi' | 'forecast';
...
export type FilterOperator = 'eq' | 'ne' | 'gt' | 'gte' | 'lt' | 'lte' | 'in' | 'nin' | 'contains' | 'between';
...
export type SectionType = 'summary' | 'metrics' | 'chart' | 'insights' | 'recommendations' | 'forecast';
...
export type ReportStatus = 'draft' | 'scheduled' | 'generating' | 'completed' | 'failed' | 'canceled';
