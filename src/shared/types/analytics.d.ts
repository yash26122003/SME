...
export type WidgetType = 'SALES_FORECAST' | 'CUSTOMER_CLV' | 'CHURN_PREDICTION' | 'CASH_FLOW' | 'PROFITABILITY' | 'KPI_CARD' | 'TREND_CHART' | 'PIE_CHART' | 'BAR_CHART' | 'HEATMAP' | 'GAUGE' | 'TABLE';
